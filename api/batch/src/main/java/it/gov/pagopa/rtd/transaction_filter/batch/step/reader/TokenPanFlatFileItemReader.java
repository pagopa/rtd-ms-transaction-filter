 ...
 */
public class TokenPanFlatFileItemReader extends FlatFileItemReader<InboundTokenPan> {
    ...
    private LineMapper<InboundTokenPan> lineMapper;
    ...
    public TokenPanFlatFileItemReader() {
    ...
    public void setLineMapper(LineMapper<InboundTokenPan> lineMapper) {
    ...
    @Nullable
    protected InboundTokenPan doRead() throws Exception {
        if (this.noInput) {
            return null;
        } else {
